...
ALTER TYPE public.account_type
    OWNER TO torres60852;

CREATE TABLE IF NOT EXISTS public.classification -- table classification
( 
...
CREATE TABLE IF NOT EXISTS public.inventory -- table inventory
(
...
CREATE TABLE IF NOT EXISTS public.comment                                     -- this is new
(
  comment_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  account_id integer NOT NULL,
  comment_text text NOT NULL,
  comment_rate INTEGER CHECK (comment_rate BETWEEN 1 AND 5) DEFAULT NULL,
...
VALUES ('Custom'), -- data table for classification
	   ('Sport'),
	   ('SUV'),
	   ('Truck'),
	   ('Sedan');
